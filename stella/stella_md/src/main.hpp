...
bool ahrs_yaw_init = false;
bool encoder_init = false;
double ahrs_yaw_first = 0.0;
double ahrs_yaw, delta_th=0.0,delta_s=0.0,delta_x=0.0,delta_y=0.0,x=0.0,y=0.0,th=0.0,delta_left = 0,delta_right = 0, dt = 0.0;
