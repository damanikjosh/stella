...
int stella_setting(int select)
{
    ...
    case 0:
        ...
        stella.Max_velocity[channel_1] = 6000;
        stella.Max_velocity[channel_2] = 6000;

        stella.Acceleration[channel_1] = 6000;
        stella.Acceleration[channel_2] = 6000;

        stella.Deceleration[channel_1] = 6000;
        stella.Deceleration[channel_2] = 6000;
        ...
        // 로봇 기구학 셋팅
        Differential_MobileRobot_SetValue.axle_length   = 0.1878;            // 바퀴간 거리             (m)
        Differential_MobileRobot_SetValue.wheel_radius  = 0.0311;           // 바퀴 반지름             (m)
